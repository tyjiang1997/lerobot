...
class XLerobotConfig(RobotConfig):
    ...
    port1: str = "/dev/tty.usbmodem5AB01582561"  # port to connect to the bus (so101 + head camera)
    port2: str = "/dev/tty.usbmodem5A7C1229581"  # port to connect to the bus (same as lekiwi setup)
